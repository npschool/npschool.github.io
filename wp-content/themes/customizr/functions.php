...
<div class="span3 credits">
    		    	<p> &middot; &copy; '.'2015'.' <a href="'.esc_url( home_url() ).'" title="'.'Let Another Lamp Be Enlighten'.'" rel="bookmark">'.'<strong>Nagarjuna Educational Institutions</strong>'.'</a><br> &middot; '.($credits ? $credits : 'Designed & Maintained by <a href="http://www.aascar.in/"><strong>AASCAR Solutions</strong></a>').' &middot;'.($newline_credits ? '<br />&middot; '.$newline_credits.' &middot;' : '').'</p>		</div>';
}
